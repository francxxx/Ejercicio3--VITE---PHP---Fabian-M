...
<body>
    ...
    <header class="header02">
        ...
        <p class="header02__eyebrow">Kaixo!</p>
        <h3 class="header02__title">Jarri nirekin harremanetan!</h3>
        <p class="header02__text">EZAGUTU DISEINUAREN MUNDUA!</p>
        ...
        <section>
            ...
            <article class="artForm02">          
                ...
                <div>
                    ...
                    <form id="idForAjax" action=<?= e(app_url('/app/artForm02')) ?>
